...
if (!function_exists('responsi_ih_frontend')) {
    function responsi_ih_frontend()
    {
        ...
        ?>
        <div id="ih-layout" class="ih-layout ih-clearfix<?php echo esc_attr($ih_sticky);?><?php echo esc_attr($_ih_mobile_scroll).esc_attr($_ih_tablet_scroll);?>">
            <div id="ih-ctn" class="ih-ctn ih-clearfix ih-header<?php echo esc_attr($_ih_mobile_scroll).esc_attr($_ih_tablet_scroll);?>">
                <div id="ih-wrap" class="ih-clearfix ih-animation <?php echo esc_attr($animation_class);?>"<?php echo esc_attr($animation_data) . esc_attr($animation_style);?>>
                    <div id="ih-wide" class="ih-wide ih-clearfix<?php echo esc_attr($custom_width_class);?>">
                        <div id="ih-content-wrap" class="ih-content-wrap ih-clearfix ih-column-<?php echo esc_attr($_ih_column);?>">
                            <div id="ih-content" class="ih-content ih-tablet-<?php echo esc_attr($responsi_ih_tablet);?> ih-mobile-<?php echo esc_attr($responsi_ih_mobile);?>">
                                <?php
                                ...
                                if ($_ih_column >= 1) {
                                    ...
                                    ?>
                                    <div id="ih-area-1" class="ih-area ih-area-logo" style="width:<?php echo esc_attr($width);?>%">
