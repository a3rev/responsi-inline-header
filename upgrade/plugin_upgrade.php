...
class Responsi_IH_Upgrade
{

	protected $plugin_key     = RESPONSI_IH_KEY;
	protected $plugin_version = RESPONSI_IH_VERSION;
	protected $plugin_path    = RESPONSI_IH_NAME;
